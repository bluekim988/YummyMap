		...
		<div class="row">
			<div class="col-2 bor-bottom-top bor-right padd-right">
				<div class="padd-text mt-4">
					<a href="http://localhost/YummyMap/member/member.mmy"
						style="color: black" class="font-weight-bold"><h6>회원정보
							변경</h6></a>
				</div>
				<div class="padd-text">
					<a href="http://localhost/YummyMap/member/txtList.mmy"
						style="color: black" class="font-weight-bold"><h6>내가 쓴글
							보기</h6></a>
				</div>
				<div class="mar-top bor-bottom-or padd-text">
					<a href="#myModal" style="color: black" class="font-weight-bold" data-toggle="modal" id="mlink"><h6>회원탈퇴</h6></a>
